...
using AdvancedProgramming.Logic;
...
namespace AdvancedProgramming.Controllers
{
    public class TasksController : Controller
    {
        ...
        // La clase TaskController depende de la abstraccion, no de una impplementación concreta
        ...
        TaskGenerator taskGenerator = new TaskGenerator();
            var taskViewModels = taskGenerator.GetTasks();
